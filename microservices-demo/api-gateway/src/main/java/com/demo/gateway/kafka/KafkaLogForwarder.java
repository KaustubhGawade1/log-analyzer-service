package com.demo.gateway.kafka;
...
/**
 * Forwards application log events to Kafka topic for the Log Analyzer.
 * Bridges real microservice logs with the Kafka-based analysis pipeline.
 */
@Component
public class KafkaLogForwarder {
    ...
    private void send(String level, String message, Throwable throwable) {
        try {
            ...
            // Include trace context from MDC (set by Micrometer Tracing)
    ...
    private String getStackTrace(Throwable throwable) {
        ...
        // Limit to first 3 lines for clustering efficiency
